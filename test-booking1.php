  ...
  <section class="booking-form">
    <div class="container">
      ...
      <form autocomplete="off" method="post" id="testBooking" name="bookingForm" class="">
        ...
        <div class="form-group">
          <span class="input input--nao">
            <input class="input__field input__field--nao" name="phone" type="tel" />
            <label class="input__label input__label--nao" for="input-1">
        ...
        <div class="form-group">
          <span class="input input--nao">
            ...
            <select class="input__field input__field--nao select-dd select-test" name="option">
              <option value=""></option>
        ...
        <div class="form-group city-box">
          <span class="input input--nao">
            <img src="images/arrow-down-icon.png" class="arrow-icon" />
            <select name="city" class="input__field input__field--nao select-dd city-dd"></select>
            <label class="input__label input__label--nao" for="input-1">
        ...
        <div class="form-group duration-box">
          <span class="input input--nao">
            <img src="images/arrow-down-icon.png" class="arrow-icon" />
            <select name="days" class="input__field input__field--nao select-dd test-duration">
              <option value=""></option>
              <option>1 day</option>
        ...
        <p class="availability"><span>*</span>Available in Delhi-NCR, Mumbai, Chennai and Bengaluru.</p>
